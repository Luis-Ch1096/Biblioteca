<%@ Page Title="" Language="C#" MasterPageFile="~/CapaVista/Site1.Master" AutoEventWireup="true" CodeBehind="Devolver.aspx.cs" Inherits="sistema_gestion_biblioteca.CapaVista.Devolver" %>
...
<br />
 ...
 <asp:TextBox ID="Txtid_libro" runat="server" Width="24px"></asp:TextBox>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <asp:Button ID="Btn_Devolver" runat="server" Text="Devolver Libro" />
 <br />
 <br />
